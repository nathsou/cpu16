...
set_property PACKAGE_PIN P8 [get_ports {io_an[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_an[0]}]
set_property PACKAGE_PIN R8 [get_ports {io_an[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_an[1]}]
set_property PACKAGE_PIN N9 [get_ports {io_an[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_an[2]}]
set_property PACKAGE_PIN P9 [get_ports {io_an[3]}]
